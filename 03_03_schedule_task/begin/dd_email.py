...
class DailyDigestEmail:
    ...
    def __init__(self):
        self.content = {'quote': {'include': True, 'content': dd_content.get_random_quote()},
                        ...
                        'fashion': {'include': True, 'content': dd_content.get_skincare_articles()}}

        self.recipients_list = ['RECIPIENT 1',
                                'RECIPIENT 2']

        self.sender_credentials = {'email': 'YOUR-OWN-EMAIL-ADDRESS', # your sender email address
                                   'password': 'YOUR-OWN-PASSWORD'} # your sender password
